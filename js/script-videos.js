function initFetchFundamentos() {
    ...
    function createAula(aula) {
      ...
      li.innerHTML = `<a class="link-aula" href="fundamento${aula.id}.php"><img class="img-aula" src="${aula.thumbnail}" alt=""><p class="titulo-aula">${aula.titulo}</p></a>`
...
function initFetchExercicios() {
  ...
  function createAula(aula) {
    const li = document.createElement('li')
    li.classList.add("list-item")
    li.innerHTML = `<a class="link-aula" href="exercicio${aula.id}.php"><img class="img-aula" src="${aula.thumbnail}" alt=""><p class="titulo-aula">${aula.titulo}</p></a>`
